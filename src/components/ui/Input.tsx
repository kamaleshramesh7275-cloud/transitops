  ...
  return (
    <div className="w-full flex flex-col gap-1.5">
      ...
      <div className="relative flex items-center">
        {leftIcon && (
          <span className="absolute left-3 text-zinc-400 flex items-center justify-center pointer-events-none">
            {leftIcon}
          </span>
        )}
        <input
          ...
          id={inputId}
          type={type}
          className={`w-full bg-[#18181b] border border-[#27272a] rounded-lg text-zinc-200 text-sm py-2.5 transition-all duration-200 focus:outline-none focus:border-brand-primary/80 focus:ring-1 focus:ring-brand-primary/30 placeholder-zinc-600
            ${leftIcon ? 'pl-10' : 'pl-4'}
