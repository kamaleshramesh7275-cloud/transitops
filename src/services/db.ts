...
export function initializeMockData() {
  ...
  const mockMaintenance = [
    ...
    { id: 'maint_4', vehicleId: 'veh_4', type: 'repair', description: 'Radiator Leak Fix', status: 'completed', cost: 6500.00, scheduledDate: new Date(Date.now() - 20 * 24 * 60 * 60 * 1000).toISOString(), startDate: new Date(Date.now() - 20 * 24 * 60 * 60 * 1000).toISOString(), completionDate: new Date(Date.now() - 19 * 24 * 60 * 60 * 1000).toISOString(), odometerReading: 14500, performedBy: 'Local Garage, Vijayawada', createdAt: new Date(Date.now() - 21 * 24 * 60 * 60 * 1000).toISOString(), updatedAt: new Date(Date.now() - 19 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'maint_5', vehicleId: 'veh_7', type: 'routine', description: 'Filters and Oil Change', status: 'completed', cost: 11000.00, scheduledDate: new Date(Date.now() - 40 * 24 * 60 * 60 * 1000).toISOString(), startDate: new Date(Date.now() - 40 * 24 * 60 * 60 * 1000).toISOString(), completionDate: new Date(Date.now() - 39 * 24 * 60 * 60 * 1000).toISOString(), odometerReading: 140000, performedBy: 'Eicher Auth Service, Kochi', createdAt: new Date(Date.now() - 45 * 24 * 60 * 60 * 1000).toISOString(), updatedAt: new Date(Date.now() - 39 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'maint_6', vehicleId: 'veh_10', type: 'inspection', description: 'Annual Fitness Certificate Inspection', status: 'scheduled', cost: 5000.00, scheduledDate: new Date(Date.now() + 15 * 24 * 60 * 60 * 1000).toISOString(), odometerReading: 62000, performedBy: 'RTO Authorized Center, Bangalore', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() }
  ];
  ...
  const mockFuel = [
    ...
    { id: 'fuel_6', vehicleId: 'veh_1', driverId: 'driver_1', tripId: 'trip_5', date: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), liters: 100, costPerLiter: 93.50, totalCost: 9350.00, odometerReading: 44900, fuelStation: 'Shell, Peenya', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'fuel_7', vehicleId: 'veh_7', driverId: 'driver_7', tripId: 'trip_3', date: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), liters: 80, costPerLiter: 94.00, totalCost: 7520.00, odometerReading: 144800, fuelStation: 'IndianOil, Thrissur', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'fuel_8', vehicleId: 'veh_9', driverId: 'driver_9', tripId: 'trip_4', date: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(), liters: 25, costPerLiter: 92.80, totalCost: 2320.00, odometerReading: 77850, fuelStation: 'BPCL, Dindigul', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'fuel_9', vehicleId: 'veh_10', driverId: 'driver_10', tripId: 'trip_7', date: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), liters: 200, costPerLiter: 92.00, totalCost: 18400.00, odometerReading: 61500, fuelStation: 'Nayara Energy, Chengalpattu', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'fuel_10', vehicleId: 'veh_8', driverId: 'driver_8', tripId: 'trip_6', date: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString(), liters: 60, costPerLiter: 94.50, totalCost: 5670.00, odometerReading: 11800, fuelStation: 'IndianOil, Kollam', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() }
  ];
  ...
  const mockExpenses = [
    ...
    { id: 'exp_6', category: 'toll', amount: 350.00, date: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString(), vehicleId: 'veh_1', driverId: 'driver_1', tripId: 'trip_5', description: 'Attibele Toll', status: 'approved', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'exp_7', category: 'toll', amount: 500.00, date: new Date(Date.now() - 48 * 60 * 60 * 1000).toISOString(), vehicleId: 'veh_7', driverId: 'driver_7', tripId: 'trip_3', description: 'Paliyekkara Toll Plaza', status: 'rejected', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'exp_8', category: 'fine', amount: 2000.00, date: new Date(Date.now() - 72 * 60 * 60 * 1000).toISOString(), vehicleId: 'veh_9', driverId: 'driver_9', tripId: 'trip_4', description: 'Over-speeding challan near Karur', status: 'pending', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'exp_9', category: 'maintenance', amount: 6500.00, date: new Date(Date.now() - 20 * 24 * 60 * 60 * 1000).toISOString(), vehicleId: 'veh_4', description: 'Radiator Leak Fix', status: 'approved', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'exp_10', category: 'fuel', amount: 9350.00, date: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), vehicleId: 'veh_1', driverId: 'driver_1', tripId: 'trip_5', description: 'Diesel refill at Peenya', status: 'approved', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() }
  ];
